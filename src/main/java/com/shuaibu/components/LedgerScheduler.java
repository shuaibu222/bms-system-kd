...
public class LedgerScheduler {
    ...
    public void generateMonthlyLedgerSummary() {
        ...
        // lastMonth.withDayOfMonth(lastMonth.lengthOfMonth()); // June 30

        LocalDate startOfLastMonth = LocalDate.of(2025, 06, 01); // June 1
        LocalDate endOfLastMonth = LocalDate.of(2025, 06, 30); // June 30
